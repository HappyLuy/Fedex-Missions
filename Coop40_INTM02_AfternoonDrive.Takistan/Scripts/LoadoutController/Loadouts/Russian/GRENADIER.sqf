...
(backpackContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_HE_GP25_M", 14];
(backpackContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_SmokeRed_GP25_M", 4];
(backpackContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_SmokeGreen_GP25_M", 4];
