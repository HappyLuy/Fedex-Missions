...
(backpackContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_HE_GP25_M", 12];
(backpackContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_SmokeRed_GP25_M", 2];
(backpackContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_SmokeGreen_GP25_M", 2];

// Add Weapons
(uniformContainer _unit) addMagazineCargoGlobal ["CUP_30Rnd_545x39_AK_M",1];
(uniformContainer _unit) addMagazineCargoGlobal ["CUP_1Rnd_HE_GP25_M",1];
(uniformContainer _unit) addMagazineCargoGlobal ["CUP_8Rnd_9x18_Makarov_M",1];
_unit addWeaponGlobal "CUP_arifle_AK107_GL";
